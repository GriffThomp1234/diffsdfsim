...
def mesh_sdf_demo(scene, output_dir=experiment_basedir):
   ...
   # Create the world and run the simulation once
   ...
   # Commented out the optimization part
...
def make_world(decoder, latent):
   ...
   m = SDF3D(pos=[0, 1.4, 0], scale=2, sdf_func=decode_igr(decoder), params=[latent], col=(0, 0, 255),
